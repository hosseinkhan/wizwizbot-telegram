...
if ($from_id == $admin || $userInfo['isAdmin'] == true) {
	...
	$mainKeys[] = [['text'=>'🛒 خرید فیلترشکن جدید','callback_data'=>"buySubscription"]];
	$mainKeys[] = [['text'=>'📦 باقیمانده اکانت های من','callback_data'=>'mySubscriptions']];
	$mainKeys[] = [['text'=>"🧑‍💼 کیف پول من",'callback_data'=>"myInfo"]];
    $mainKeys[] = [['text'=>'🔗 دانلود نرم افزارها','callback_data'=>"reciveApplications"]];
	$mainKeys[] = [['text'=>"📨 درخواست پشتیبانی",'callback_data'=>"supportSection"]];
    ...
    if($botState['sellState']=="on"){
        $keys[] = [['text'=>'🛒 خرید فیلترشکن جدید','callback_data'=>"buySubscription"]];
		$keys[] = [['text'=>'📦 باقیمانده اکانت های من','callback_data'=>'mySubscriptions']];
    }
    $keys[] = [['text'=>"🧑‍💼 کیف پول من",'callback_data'=>"myInfo"]];
    $keys[] = [['text'=>'🔗 دانلود نرم افزارها','callback_data'=>"reciveApplications"],];
	$keys[] = [['text'=>"📨 درخواست پشتیبانی",'callback_data'=>"supportSection"]];
